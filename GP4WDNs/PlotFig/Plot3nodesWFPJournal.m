function Plot3nodeWFPJournal(SolutionCell)
...
scatter3(initalpoint(:,1),initalpoint(:,2),initalpoint(:,3),Marksize,Color_d,'filled');
hold on
...
lgd = legend('Surface (40a) ','Surface (40b)','Surface (40c)','Iterate process');
set(lgd,...
