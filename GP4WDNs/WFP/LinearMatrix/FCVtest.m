...
if(TestCase == 4)
    %inpname='tutorial5node.inp';
    %inpname='tutorial8nodefcv_losscoeff.inp';
    inpname='tutorial8nodefcv_losscoeff500.inp';
...
for i = 1:1
    ...
    %X0(IndexInVar.PumpFlowIndex) = 1;%InitialParameter.PipeFLowAverage(IndexInVar.PumpFlowIndex)*LPS2GMP;
    ...
    X0(56,1) = 0;% assume that only this initial value is not correct
    Wsolution = [];
